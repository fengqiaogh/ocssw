...
int readl1(filehandle *l1file, int32_t recnum, l1str *l1rec) {
    ...
    case FT_CZCSL1A:
        ...
        break;
    case FT_MODISL1B:
        status = readl1_modis(l1file, recnum, l1rec);
        break;
    case FT_CLASSAVHRR:
    ...
    case FT_VIIRSL1B:
        ...
        break;
    case FT_VIIRSL1BNC:
        status = readl1_viirs_l1b(l1file, recnum, l1rec);
        break;
    case FT_VIIRSL1A:
    ...
    case FT_OCIA:
        ...
        break;
    case FT_OCIL1B:
        status = readl1_oci(l1file,recnum,l1rec);
        break;
    case FT_OCIS:
...
int readl1_lonlat(filehandle *l1file, int32_t recnum, l1str *l1rec) {
    ...
    case FT_SEAWIFSL1A:
        ...
        break;
    case FT_MODISL1B:
        status = readl1_lonlat_modis(l1file, recnum, l1rec);
        break;
    case FT_MERISL1B:
    ...
    case FT_VIIRSL1B:
        ...
        break;
    case FT_VIIRSL1BNC:
        status = readl1_lonlat_viirs_l1b(l1file, recnum, l1rec);
        break;
    case FT_HICOL1B:
    ...
    case FT_L7ETML1B:
        ...
        break;
    case FT_MSIL1C:
         status = readl1_msi_lonlat(l1file, recnum, l1rec);
         break;
    default:
