...
class l1aFile {
 ...
 public:
  ...
  int createl1( char* l1_filename, uint16_t maxsc,
  ...
  int write_oci_scan_metadata( uint32_t isc, uint8_t *ancdata,
  ...
  int write_oci_tlm_data( itab *itable, uint32_t ntlm, uint8_t (*tlmdata)[TLMSIZE],
...
int check_load_oci_data( short dtype, uint16_t ncps, uint16_t nsps,
                         uint16_t ndcs, uint16_t ndss,
                         uint16_t nbbs, uint16_t nrbs, uint16_t nswb,
...
int createNCDF( netCDF::NcGroup &ncGrp, const char *sname, const char *lname, 
