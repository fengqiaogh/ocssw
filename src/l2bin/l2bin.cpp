...
int main(int argc, char **argv)
{
    ...
    std::vector<netCDF::NcDim> dims_nc;
    int32_t dims[3];
    ...
    */
    ...
    for (ifile = 0; ifile < nfiles; ifile++)
    {
        ...
        // std::cout << "Requested products " << products_requested << std::endl;
        set_mapper(input.files[ifile], products_requested, products_requested_separated);
    ...
    set_prodname_3d_to_l2bin(input, prodparam, l2_str[0], l2_prodname, l3_prodname, thirdDimId, min_value, max_value); 
    ...
    for (ifile = 0; ifile < nfiles; ifile++)
    {
        ...
        try
        {
            ...
            netCDF::NcGroup scan_grp = nc_input.getGroup("scan_line_attributes");
    ...
    for (ifile = 0; ifile < nfiles; ifile++)
    {
            ...
            case SEAWIFS:
                ...
                if (l2_str[ifile].syear > 2002)
                {
                    ...
                    */
                    ...
                    if (d < 3843)
                    {
                        deg = 7.7517951e-10 * d * d * d - 2.1692192e-06 * d * d + 0.00706692410 * d - 4.1300585;
                    }
                    else
                    {
                        /*
        ...
        try
        {
            ...
            netCDF::NcGroup nav_grp = nc_input.getGroup("navigation_data");
