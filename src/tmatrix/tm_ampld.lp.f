...
C   accompanying files lpd.f and tm_ampld.par.f.
...
C   value specified in the PARAMETER statement in the file tm_ampld.par.f.
...
C   tm_ampld.par.f.  It is recommended to keep NPN1=NPN4+25 and
...
Cf2py intent(out) nmax
     ...
     *        DDR(NPNG2),DRR(NPNG2),DRI(NPNG2),ANN(NPN1,NPN1)
     ...
     &     IT21(NPN6,NPN4,NPN4),IT22(NPN6,NPN4,NPN4)
      ...
      COMMON /CT/ TR1,TI1
      COMMON /TMATC/ RT11,RT12,RT21,RT22,IT11,IT12,IT21,IT22
...
C   CALCULATION OF THE AMPLITUDE MATRIX       
     ...
     *       CTP1,CPP1
     ...
     &     TI21(NPN6,NPN4,NPN4),TI22(NPN6,NPN4,NPN4)
      ...
      COMMON /TMATC/ TR11,TR12,TR21,TR22,TI11,TI12,TI21,TI22
