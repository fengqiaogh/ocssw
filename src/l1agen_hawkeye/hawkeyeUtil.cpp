...
int getSHpacket( ifstream *framefile, uint8_t frame[892], int& framePtr,
  ...
  if (framePtr > (892-6)) {
    ...
    if (framePtr > 892) {
      long long int pos = framefile->tellg();   // V0.81
      cout << "Bad frame pointer: " << framePtr << " " << pos << endl;
    ...
    if (dataLen < 0) {
      long long int pos = framefile->tellg();   // V0.81
      cout << "Bad dataLen type1: " << dataLen << " " << pos << endl;
    ...
    *packet = new uint8_t[SHDRLEN+PUSLEN+dataLen];
    ...
    if (((*packet)[7] < 253 || (*packet)[7] > 255) && apid != 2047) {
      long long int pos = framefile->tellg();   // V0.81
      cout << "Bad PUS type1: " << (int) (*packet)[7] << " " << pos << endl;
    ...
    if (dataLen < 0) {
      long long int pos = framefile->tellg();   // V0.81
      cout << "Bad dataLen type2: " << dataLen << " " << pos << endl;
    ...
    *packet = new uint8_t[SHDRLEN+PUSLEN+dataLen];
    ...
    if (((*packet)[7] < 253 || (*packet)[7] > 255) && apid != 2047) {
      long long int pos = framefile->tellg();   // V0.81
      cout << "Bad PUS type2: " << (int) (*packet)[7] << " " << pos << endl;
    ...
    if (dataLen < 0) {
      long long int pos = framefile->tellg();   // V0.81
      cout << "Bad dataLen type3: " << dataLen << " " << pos << endl;
    ...
    *packet = new uint8_t[SHDRLEN+PUSLEN+dataLen];
    ...
    if (((*packet)[7] < 253 || (*packet)[7] > 255) && apid != 2047) {
      long long int pos = framefile->tellg();   // V0.81
      cout << "Bad PUS type3: " << (int) (*packet)[7] << " " << pos << endl;
	...
	*/
    ...
    if (dataLen < 0) {
      long long int pos = framefile->tellg();   // V0.81
      cout << "Bad dataLen type4: " << dataLen << " " << pos << endl;
    ...
    *packet = new uint8_t[SHDRLEN+PUSLEN+dataLen];
    ...
    if (((*packet)[7] < 253 || (*packet)[7] > 255) && apid != 2047) {
      long long int pos = framefile->tellg();   // V0.81
      cout << "Bad PUS type4: " << (int) (*packet)[7] << " " << pos << endl;
