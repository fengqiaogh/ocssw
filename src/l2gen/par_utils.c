...
float EstimateWatVap(int32_t year, int32_t month, int32_t day, float lat) {
    ...
    float tabwv[12][35] = {
        { 0.42, 0.47, 0.52, 0.56, 0.61, 0.66, 0.71, 0.75,
